...
def confirm(): #defining confirmation function
     confirmation = input("\033[103m\033[90m\033[1m Are you sure? (y/n): \033[0m") 
     if confirmation.upper() == "Y":
        return True
     elif confirmation.upper() == "N":
        print("\033[103m\033[90m\033[1mCANCELLED\033[0m")
        return False
     else:
        print("\033[103m\033[90m\033[1mINVALID INPUT\033[0m")
        return False
...
while True:
    ...
    if message.upper() == "EXIT":
        if confirm():
            ...
            break
    elif message.upper() == "CLEAR":  # clearing terminal
        if confirm():
            chat.clear()
